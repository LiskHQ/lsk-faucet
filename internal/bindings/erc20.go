...
func (_Token *TokenCaller) BRIDGE(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "BRIDGE")
...
//
// Solidity: function BRIDGE() view returns(address)
func (_Token *TokenSession) BRIDGE() (common.Address, error) {
	return _Token.Contract.BRIDGE(&_Token.CallOpts)
}

// BRIDGE is a free data retrieval call binding the contract method 0xee9a31a2.
//
// Solidity: function BRIDGE() view returns(address)
func (_Token *TokenCallerSession) BRIDGE() (common.Address, error) {
	return _Token.Contract.BRIDGE(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) REMOTETOKEN(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "REMOTE_TOKEN")
...
//
// Solidity: function REMOTE_TOKEN() view returns(address)
func (_Token *TokenSession) REMOTETOKEN() (common.Address, error) {
	return _Token.Contract.REMOTETOKEN(&_Token.CallOpts)
}

// REMOTETOKEN is a free data retrieval call binding the contract method 0x033964be.
//
// Solidity: function REMOTE_TOKEN() view returns(address)
func (_Token *TokenCallerSession) REMOTETOKEN() (common.Address, error) {
	return _Token.Contract.REMOTETOKEN(&_Token.CallOpts)
}
...
func (_Token *TokenCaller) RemoteToken(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Token.contract.Call(opts, &out, "remoteToken")
...
//
// Solidity: function initialize(address bridgeAddr) returns()
func (_Token *TokenTransactor) Initialize(opts *bind.TransactOpts, bridgeAddr common.Address) (*types.Transaction, error) {
	return _Token.contract.Transact(opts, "initialize", bridgeAddr)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address bridgeAddr) returns()
func (_Token *TokenSession) Initialize(bridgeAddr common.Address) (*types.Transaction, error) {
	return _Token.Contract.Initialize(&_Token.TransactOpts, bridgeAddr)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address bridgeAddr) returns()
func (_Token *TokenTransactorSession) Initialize(bridgeAddr common.Address) (*types.Transaction, error) {
	return _Token.Contract.Initialize(&_Token.TransactOpts, bridgeAddr)
}
...
// TokenBridgeAddressChangedIterator is returned from FilterBridgeAddressChanged and is used to iterate over the raw logs and unpacked data for BridgeAddressChanged events raised by the Token contract.
type TokenBridgeAddressChangedIterator struct {
	Event *TokenBridgeAddressChanged // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *TokenBridgeAddressChangedIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(TokenBridgeAddressChanged)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *TokenBridgeAddressChangedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *TokenBridgeAddressChangedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// TokenBridgeAddressChanged represents a BridgeAddressChanged event raised by the Token contract.
type TokenBridgeAddressChanged struct {
	OldBridgeAddr common.Address
	NewBridgeAddr common.Address
	Raw           types.Log // Blockchain specific contextual infos
}

// FilterBridgeAddressChanged is a free log retrieval operation binding the contract event 0xecfc86cbcf0a44a77658de7fc62df1f08579e15cc8f872b51231ec8a19bc8507.
//
// Solidity: event BridgeAddressChanged(address indexed oldBridgeAddr, address indexed newBridgeAddr)
func (_Token *TokenFilterer) FilterBridgeAddressChanged(opts *bind.FilterOpts, oldBridgeAddr []common.Address, newBridgeAddr []common.Address) (*TokenBridgeAddressChangedIterator, error) {

	var oldBridgeAddrRule []interface{}
	for _, oldBridgeAddrItem := range oldBridgeAddr {
		oldBridgeAddrRule = append(oldBridgeAddrRule, oldBridgeAddrItem)
	}
	var newBridgeAddrRule []interface{}
	for _, newBridgeAddrItem := range newBridgeAddr {
		newBridgeAddrRule = append(newBridgeAddrRule, newBridgeAddrItem)
	}

	logs, sub, err := _Token.contract.FilterLogs(opts, "BridgeAddressChanged", oldBridgeAddrRule, newBridgeAddrRule)
	if err != nil {
		return nil, err
	}
	return &TokenBridgeAddressChangedIterator{contract: _Token.contract, event: "BridgeAddressChanged", logs: logs, sub: sub}, nil
}

// WatchBridgeAddressChanged is a free log subscription operation binding the contract event 0xecfc86cbcf0a44a77658de7fc62df1f08579e15cc8f872b51231ec8a19bc8507.
//
// Solidity: event BridgeAddressChanged(address indexed oldBridgeAddr, address indexed newBridgeAddr)
func (_Token *TokenFilterer) WatchBridgeAddressChanged(opts *bind.WatchOpts, sink chan<- *TokenBridgeAddressChanged, oldBridgeAddr []common.Address, newBridgeAddr []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "BridgeAddressChanged", oldBridgeAddrRule, newBridgeAddrRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(TokenBridgeAddressChanged)
				if err := _Token.contract.UnpackLog(event, "BridgeAddressChanged", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseBridgeAddressChanged is a log parse operation binding the contract event 0xecfc86cbcf0a44a77658de7fc62df1f08579e15cc8f872b51231ec8a19bc8507.
//
// Solidity: event BridgeAddressChanged(address indexed oldBridgeAddr, address indexed newBridgeAddr)
func (_Token *TokenFilterer) ParseBridgeAddressChanged(log types.Log) (*TokenBridgeAddressChanged, error) {
	event := new(TokenBridgeAddressChanged)
	if err := _Token.contract.UnpackLog(event, "BridgeAddressChanged", log); err != nil {
		return nil, err
	}
...
func (_Token *TokenFilterer) FilterBurn(opts *bind.FilterOpts, account []common.Address) (*TokenBurnIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "Burn", accountRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Burn(address indexed account, uint256 amount)
func (_Token *TokenFilterer) WatchBurn(opts *bind.WatchOpts, sink chan<- *TokenBurn, account []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "Burn", accountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
func (_Token *TokenFilterer) FilterMint(opts *bind.FilterOpts, account []common.Address) (*TokenMintIterator, error) {
	...
	logs, sub, err := _Token.contract.FilterLogs(opts, "Mint", accountRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Mint(address indexed account, uint256 amount)
func (_Token *TokenFilterer) WatchMint(opts *bind.WatchOpts, sink chan<- *TokenMint, account []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Token.contract.WatchLogs(opts, "Mint", accountRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
